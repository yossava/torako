class StaticsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @static.save
        format.html { redirect_to :back, notice: 'Halaman telah dibuat.' }
  ...
  def update
    respond_to do |format|
      if @static.update(static_params)
        format.html { redirect_to :back, notice: 'Halaman diperbarui' }
  ...
  def destroy
    @static.destroy
    respond_to do |format|
      format.html { redirect_to statics_url, notice: 'Halaman dihapus' }
