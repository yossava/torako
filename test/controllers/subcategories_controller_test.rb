...
class SubcategoriesControllerTest < ActionController::TestCase
  ...
  test "should create subcategory" do
    assert_difference('Subcategory.count') do
      post :create, subcategory: { deskripsi: @subcategory.deskripsi, parent_id: @subcategory.parent_id, subcategori_image: @subcategory.subcategori_image, subkategori: @subcategory.subkategori }
    end
  ...
  test "should update subcategory" do
    patch :update, id: @subcategory, subcategory: { deskripsi: @subcategory.deskripsi, parent_id: @subcategory.parent_id, subcategori_image: @subcategory.subcategori_image, subkategori: @subcategory.subkategori }
    assert_redirected_to subcategory_path(assigns(:subcategory))
  end
